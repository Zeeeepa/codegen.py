...
from codegen.core import AgentRunLogResponse, AgentRunResponse, AgentRunWithLogsResponse
...
class TestTask:
    ...
    def test_task_is_running_property(self, mock_client):
        ...
        # Configure mock to return the running response when refresh is called
