...
from ui.utils.constants import THEME, DEFAULT_WINDOW_SIZE, MIN_WINDOW_SIZE
...
class CodegenApplication:
    ...
    def __init__(self):
        ...
        logger.info("Initializing Codegen UI application")
        ...
        logger.info("Codegen UI application initialized")
    ...
    def _on_close(self):
        ...
        logger.info("Closing Codegen UI application")
    ...
    def run(self):
        """Run the application."""
        logger.info("Starting Codegen UI application")
        self.root.mainloop()
